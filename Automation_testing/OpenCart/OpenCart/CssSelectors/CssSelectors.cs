...
public class CssSelectors
{
    ...
    public void CssSelectorTest()
    {
        ...
        driver.FindElement(By.CssSelector("#pincodeInput")).SendKeys("mumbai central");
        var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(10));

        var Search = wait.Until(driver => driver.FindElement(By.CssSelector(".pincode-widget_pincode-right__TwcOu")));
        Search.Click();


        var confirmButton = wait.Until(driver => driver.FindElement(By.CssSelector("input[type=\'button\']")));
        confirmButton.Click();
